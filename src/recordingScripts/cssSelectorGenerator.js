...
(function () {
    ...
    CssSelectorGenerator = (function () {
        ...
        CssSelectorGenerator.prototype.quoteAttribute = function (item) {
            ...
            characters = item.split("").map(function (character) {
                if (character === ":") {
                    ...
                    quotesNeeded =
                        quotesNeeded || escape(character === !character);
        ...
        CssSelectorGenerator.prototype.getIdSelector = function (element) {
            ...
            prefix = this.options.prefix_tag
                ? this.getTagSelector(element)
                : "";
            ...
            if (
                ...
                id != null &&
                id !== "" &&
                this.notInList(id, id_blacklist)
            ) {
            ...
            if (class_string != null) {
                ...
                if (class_string !== "") {
                    ...
                    for (k = 0, len = ref.length; k < len; k++) {
                        ...
                        if (
                            this.notInList(item, this.options.class_blacklist)
                        ) {
                ...
                if (element.hasAttribute(attr)) {
                    result.push(
                        "[" +
                            attr +
                            "=" +
                            this.sanitizeAttribute(element.getAttribute(attr)) +
                            "]",
                    );
                }
            }

            blacklist = this.options.attribute_blacklist.concat([
                "id",
                "class",
            ]);
                ...
                if (
                    ...
                    result.push(
                        "[" +
                            a.nodeName +
                            "=" +
                            this.sanitizeAttribute(a.nodeValue) +
                            "]",
                    );
                }
            }
        ...
        CssSelectorGenerator.prototype.getNthChildSelector = function (
            element,
        ) {
            ...
            for (k = 0, len = ref.length; k < len; k++) {
                ...
                switch (selector_type) {
                    ...
                    case "tag":
                        if (
                            tag_selector &&
                            this.testUniqueness(element, tag_selector)
                        ) {
                    ...
                    case "class":
                        ...
                        if (selectors != null && selectors.length !== 0) {
                            selector = this.testCombinations(
                                element,
                                selectors,
                                tag_selector,
                            );
